...
## Integrante: Germán (Revisor Independiente)
...
- Limitación, dificultad o riesgo que identifiqué: Tuve inconvenientes temporales con el control de acceso en GitHub al querer empujar los cambios (403 Permission denied), lo que requiere ajustar los accesos de colaborador, sin embargo el análisis se concretó localmente. Identificamos en el análisis de riesgo que el cierre inesperado de la app en background causará pérdida de evidencia (fotos) si no guardamos la cola de operaciones.
